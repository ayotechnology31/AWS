...
Security groups (bouncer): will check when going in, will not check going out. Is Stateful
NACL's (passport control): will always check going in and going out. Is Stateless
...
Example:
Traveler: I'd like to enter.
Passport control officer: I'll check whether you're on the list.

Traveler: I'd like to exit.
Passport control officer: I'll check whether you're on the list.
...
Example:
Guest: I'm leaving, but I'll be right back!
Door attendant: Oky! I'll see you when you get back!

Guest Hi again, I'm back!
Door attendant: I remember you! Go ahead.
...
Client > Packet > Internet ---> [AWS Cloud[InternetGateway[VPC (Network access control list [Public subnet (Security group)(Security group) Amazon EC2 instances]]]


Knowledge Check
1) 
Isolate databases containing customers' personal information > Private subnet
Create a VPM connection between the VPC and the internal corporate network > Virtual private gateway
