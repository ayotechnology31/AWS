...
When you have milt. EC2 instances, how does request know which instance to go to?
Need a way to route instance. You need load balancing.

Propery distribue traffic
- High Performance
- Cost-efficient
- Highly available
